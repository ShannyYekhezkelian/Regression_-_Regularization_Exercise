 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "* We can set up a dleta to calculate the difference in the loss between two iterations and if this delta is low (the loss converges), we will stop."
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "training MSE: 44.81389962644876\n",
      "training MSE: 23.973690030862574\n",
      "training MSE: 21.95697759488851\n",
      "training MSE: 21.895094900243485\n"
     ]
    },
    {
     "data": {
   ...
   "source": [
    ...
    "    print(\"training MSE:\", RidgeLsGd_object.score(X, y))\n",
